 ...
 * user-data.php
 *
 * Contains functions that collects data from client.
 *
 * @author Ryan Haytree
 ...
 * getBrowser
 * --------------------------------
 * Get user broswer through the user agent
 *
 * @return string $browser User browser
 */
function getBrowser()
{
 ...
 * getOperatingSystem
 * --------------------------------
 * Get user operating system through the user agent
 *
 * @return string $os User operating system
 */
